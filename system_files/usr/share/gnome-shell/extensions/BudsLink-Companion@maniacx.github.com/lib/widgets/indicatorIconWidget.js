...
import {
    hexToColor, setSourceColor, getInkBounds, loadFileToCairoSurface
...
export const IndicatorIconWidget = GObject.registerClass({
    GTypeName: 'BudsLinkCompanion_IndicatorIconWidget',
}, class IndicatorIconWidget extends St.DrawingArea {
    _init(settings, indicator, deviceIcon, widgetInfo) {
