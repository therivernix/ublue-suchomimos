...
const  CustomizeRow = GObject.registerClass({
    GTypeName: 'BudsLinkCompanion_CustomizeRow',
...
export const  BatteryWidgetSettings = GObject.registerClass({
    GTypeName: 'BudsLinkCompanion_BatteryWidgetSettings',
    ...
    _updateIndicatorRowVisibility() {
        ...
        const settingsVisible = indicatorType === 0 ||
                        indicatorType === 1 && !panelSingleIndicator;
